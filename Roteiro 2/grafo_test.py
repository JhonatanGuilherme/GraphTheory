...
class TestGrafo(unittest.TestCase):
  ...
  def test_dfs(self):
    self.assertEqual(list(self.g_p.dfs('J').A),
                     ['a1', 'a2', 'a4', 'a6', 'a8', 'a9'])
    self.assertEqual(list(self.g_p.dfs('C').A),
                     ['a1', 'a2', 'a4', 'a6', 'a8', 'a9'])
    self.assertEqual(list(self.g_p.dfs('E').A),
                     ['a2', 'a1', 'a4', 'a6', 'a8', 'a9'])
    self.assertEqual(list(self.g_p.dfs('P').A),
                     ['a4', 'a1', 'a2', 'a6', 'a8', 'a9'])
    self.assertEqual(list(self.g_p.dfs('M').A),
                     ['a7', 'a1', 'a2', 'a4', 'a6', 'a9'])
    self.assertEqual(list(self.g_p.dfs('T').A),
                     ['a6', 'a1', 'a2', 'a4', 'a7', 'a9'])
    self.assertEqual(list(self.g_p.dfs('Z').A),
                     ['a9', 'a6', 'a1', 'a2', 'a4', 'a7'])

    self.assertEqual(list(self.g_p_sem_paralelas.dfs('J').A),
                     ['a1', 'a2', 'a3', 'a4', 'a6', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('C').A),
                     ['a1', 'a2', 'a3', 'a4', 'a6', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('E').A),
                     ['a2', 'a1', 'a3', 'a4', 'a6', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('P').A),
                     ['a3', 'a1', 'a2', 'a4', 'a6', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('M').A),
                     ['a5', 'a1', 'a2', 'a3', 'a4', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('T').A),
                     ['a4', 'a1', 'a2', 'a3', 'a5', 'a7'])
    self.assertEqual(list(self.g_p_sem_paralelas.dfs('Z').A),
                     ['a7', 'a4', 'a1', 'a2', 'a3', 'a5'])

    self.assertEqual(list(self.g_c.dfs('J').A),
                     ['a1', 'a4', 'a6'])
    self.assertEqual(list(self.g_c.dfs('C').A),
                     ['a1', 'a2', 'a6'])
    self.assertEqual(list(self.g_c.dfs('E').A),
                     ['a2', 'a1', 'a5'])
    self.assertEqual(list(self.g_c.dfs('P').A),
                     ['a3', 'a1', 'a4'])

    self.assertEqual(list(self.g_nd.dfs('A').A),
                     ['a1', 'a11', 'a10', 'a9', 'a4', 'a5', 'a7', 'a13', 'a14', 'a15'])
    self.assertEqual(list(self.g_nd.dfs('B').A),
                     ['a1', 'a2', 'a4', 'a5', 'a7', 'a9', 'a10', 'a13', 'a14', 'a15'])
    self.assertEqual(list(self.g_nd.dfs('C').A),
                     ['a13', 'a1', 'a2', 'a4', 'a5', 'a7', 'a9', 'a10', 'a16', 'a15'])
    self.assertEqual(list(self.g_nd.dfs('D').A),
                     ['a14', 'a13', 'a1', 'a2', 'a4', 'a5', 'a7', 'a9', 'a10', 'a17'])
    self.assertEqual(list(self.g_nd.dfs('E').A),
                     ['a15', 'a14', 'a13', 'a1', 'a2', 'a4', 'a5', 'a7', 'a9', 'a10'])
    self.assertEqual(list(self.g_nd.dfs('F').A),
                     ['a10', 'a9', 'a2', 'a1', 'a13', 'a14', 'a15', 'a3', 'a5', 'a7'])
    self.assertEqual(list(self.g_nd.dfs('G').A),
                     ['a2', 'a1', 'a11', 'a10', 'a13', 'a14', 'a15', 'a3', 'a5', 'a7'])
    self.assertEqual(list(self.g_nd.dfs('H').A),
                     ['a9', 'a2', 'a1', 'a11', 'a13', 'a14', 'a15', 'a3', 'a5', 'a7'])
    self.assertEqual(list(self.g_nd.dfs('I').A),
                     ['a7', 'a3', 'a1', 'a11', 'a10', 'a9', 'a4', 'a13', 'a14', 'a15'])
    self.assertEqual(list(self.g_nd.dfs('J').A),
                     ['a3', 'a1', 'a11', 'a10', 'a9', 'a4', 'a8', 'a13', 'a14', 'a15'])
    self.assertEqual(list(self.g_nd.dfs('K').A),
                     ['a4', 'a2', 'a1', 'a11', 'a10', 'a13', 'a14', 'a15', 'a3', 'a7'])
    with self.assertRaises(VerticeInvalidoException):
      self.g_p.arestas_sobre_vertice('A')
